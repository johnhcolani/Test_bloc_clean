...
import 'package:anywhere_variant_one/features/data_layer/data_source/models/simpsons_model.dart';
  ...
  Future<DataState<SimpsonsCharacterEntity>> fetchSimpsonsCharacter() async {
    try {
      ...
      if( response.statusCode ==200) {
        SimpsonsCharacterEntity simpsonsCharacterEntity = SimpsonsCharacter
